...
function test_sql_injection_registration_endpoint_with_random_data() {
    ...
    echo "curl -X POST http://localhost:5500/client_registeration -d 'fullName=John Doe&userName=johndoe&email=noname@maildrop.cc\" OR \"1\"=\"1&password=password&phone=1234567890'\n"
